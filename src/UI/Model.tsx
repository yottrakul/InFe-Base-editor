        ...
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
          <div className="relative w-full my-6 mx-auto max-w-3xl">
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#202123] outline-none focus:outline-none">
              ...
              {/*body*/}
              <div className="relative p-6 flex-auto text-black">{body}</div>
              {/*footer*/}
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                ...
                <button
                  className={`${error? 'bg-red-500 hover:bg-red-600':'bg-blue-500 hover:bg-blue-600'} text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150`}
                  type="button"
                  onClick={() => {
                      if (confirm) {
                        confirm();
